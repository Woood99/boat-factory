...
/* harmony import */ var _components_customSelect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/customSelect */ "./src/js/components/customSelect.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_components_customSelect__WEBPACK_IMPORTED_MODULE_6__["default"])(maskMap);
});
  ...
  function activationInputMask(container, maskMap, input) {
    for (let key in maskMap) {
      if (key === container.querySelector(classCountry).textContent.toLowerCase()) {
        const im = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())(maskMap[key]);
        im.mask(input);
      }
    }
  }
